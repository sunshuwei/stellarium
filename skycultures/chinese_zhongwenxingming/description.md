...
## chinese_zhongwenxingming 观津版中文星名拓展包（已过时）

很久以前（2017-2018，1A-1B），我一开始研究中国古天文的时候，Stellarium里的中国星空文化还很简陋。那时候听说有刘春滨版的中文星名拓展包，一直想找到资源，但网上获取不到，找到的安装方法也因为Stellarium版本不一致而无法安装。

后来索性想自己做一个，这个想法很早就有了，2017年（1A）我刚接触中国古天文时就找到了《仪象考成》资源，2018年（1B）获取到了伊世同《中西对照恒星图表》。虽然17年底中国星空文化大升级，但我没有及时更新，而且星空文化中也没有像中文星名拓展包一样详细的标注（无对照星全都没有标），所以还是希望能复刻一个一样的拓展包。这算是我那时候的一个小梦想。

具体制作的时间我已经不记得了，我找到了当时的备忘录，最后更新是2A8.3（2020年8月3日）。备忘录全文如下：

```
Stellarium中国传统星空文化计划
- [ ] 1.修改原文件中的错误：
    - [ ] *（4）多星系统多个HIP编号只标一个星名
    - [x] （1）连线错误
    - [x] （2）恒星位置错误
...
- [x] *2.汉化
    - [x] （1）星官名中文化
    - [x] （2）星名中文化
- [x] *4.自制中文星名拓展包（参考《伊世同中西对照恒星图表》、中文星名拓展包使用说明）
    - [x] （2）误差
    - [x] （1）无对照星*
```

在刘春滨版拓展包的基础上，我新添了增星连线（星群连线），所有无对照星以及误差大的恒星，我都重新依据《仪象考成》以及续编重新计算，并选取距离最近的带有HIP的恒星。

此处保留该星空文化作为纪念！

4A4.13（2026.4.13）重新尝试修复了该星空文化，感觉就像在修文物一样。由于星空文化格式的改版，当前星空文化已经和原始版本有了一些区别，例如index.json星名全被打乱了。 本次修复主要在增星连线（星群连线）上，旧版本使用座标连接的星在新版本不可用，新版本需要指定Gaia号或深空天体名。当然，本着“修旧如旧”的原则，之前由于功能受限所做的一些妥协不会优化，如无对照星使用距离最近的带有HIP的恒星，新版本完全可以指定更近的Gaia星号，或者说，有了可视化功能后也没有必要强行连星了。
...
*Suzhou Stone Carving Astronomical Map (1247)*
...
![](illustrations/hunxiang.png)

*Xingguans Map of Celestial Globe(Su Song，Song dynasty)*
...
This sky culture was contributed by *Karrie Berglund* of Digitalis Education Solutions, Inc. based on <!-- a href="http://www.lcsd.gov.hk/CE/Museum/Space/en_US/web/spm/starshine/interactive-star-maps.html" -->Hong Kong Space Museum star maps <!--/a--> (no longer available online).
