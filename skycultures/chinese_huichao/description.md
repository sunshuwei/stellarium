...
## chinese_huichao 中国天文汇钞星表（14世纪）

## Introduction

本星空文化基于中国14世纪中叶的《天文汇钞》星表（亦名《三垣列舍入宿去极集》），尽可能如实的呈现了中国元朝、明朝时期的星象。《天文汇钞》星表收录了741颗恒星的赤道座标数据，包含了中国传统1464星象格局的大半。

## Description

### 《天文汇钞》星表

该星表出自明（1368-1644）抄本《天文汇抄》中的《三垣列舍入宿去极集》，全书按照三垣、二十八宿的顺序绘制星图，在大部分恒星旁标注了座标，是一部星图、星表像结合的著作。

### 星表观测年代

该星表曾被认为是元代天文学家郭守敬（1231-1316）的观测记录。但根据所有的恒星数据计算，星表应观测于14世纪中叶，元代末年或明代初年。
